...
const variants: Record<Variant, string> = {
  card: 'border-divider dark:border-divider-dark hover:border-accent dark:bg-card-dark flex flex-col items-center border bg-white p-4 text-center',
...
export function LinkButton<R extends string>({ href, children, variant = 'card', className }: Props<R>) {
  return (
